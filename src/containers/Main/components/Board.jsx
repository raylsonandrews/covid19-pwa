...
function Board({ data }) {
    ...
    return (
        <Grid container spacing={4}>
            ...
            <Grid item xs={12} md={3}>
                <Card value={getValue(deathsPerOneMillion)} label="Total de mortes por milhão de habitantes" color="#7f7676" />
            </Grid>
            <Grid item xs={12} md={3}>
                <Card value={getValue(recovered)} label="Total de recuperados" color="#67C887" />
            </Grid>
            <Grid item xs={12} md={3}>
                <Card value={getValue(totalTests)} label="Total de testes realizados" color="#dba023" />
            </Grid>
        </Grid>
    )
}
